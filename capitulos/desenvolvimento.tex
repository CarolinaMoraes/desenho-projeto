...
\input{capitulos/section/arquitetura}

\input{capitulos/section/escopo}

\input{capitulos/section/tecnologias}

\input{capitulos/section/escalabilidade}

\input{capitulos/section/manutenibilidade}

\input{capitulos/section/segurança}

\input{capitulos/section/viabilidade}
%%% Local Variables:
%%% mode: latex
%%% TeX-master: "../desenho"
%%% End:
